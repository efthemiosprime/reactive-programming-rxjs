...
// bindCallback
var rxFetch = _Rx2.default.Observable.bindCallback(fetch);

rxFetch('url').subscribe(log);

// combine OBSERVABLESc

var o1 = _Rx2.default.Observable.interval(1000).map(function (x) {
    return 'a' + x;
});
var o2 = _Rx2.default.Observable.interval(2000).map(function (x) {
    return 'b' + x;
});
var o3 = _Rx2.default.Observable.interval(3000).map(function (x) {
    return 'c' + x;
});
...
var toggleInterval = function toggleInterval() {
    var initial = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
    var period1 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
    var period2 = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
    return _Rx2.default.Observable.create(function (sub) {
        var count = 0;
